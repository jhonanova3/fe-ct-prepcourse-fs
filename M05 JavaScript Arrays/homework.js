...
function agregarNumeros(arrayOfNums) {
   ...
   // Tu código:
   const suma = arrayOfNums.reduce((a, numero) => a + numero, 0);
   return suma;
   // var resultado = 0;
...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   const numMasGrande = Math.max(...arrayOfNums);
   return numMasGrande;
   // La función Math.max() retorna el mayor de cero 
   // o más números dados como parámetros de entrada,
...
function mesesDelAño(array) {
   ...
   for (let i = 0; i < array.length; i++) {
      if (array[i] === "Enero" || array[i] === "Marzo" || array[i] === "Noviembre") {
         nuevoArrayDeMeses.push(array[i]);
      }
   }
   ...
   //    OTRA SOLUCIÚN USANDO "INCLUDES"(El método includes() determina
   //     si una matriz incluye un determinado elemento,
